                ...
                children: [
                  Container(
                    ...
                    child: Stack(
                      ...
                      children: [
                        Align(
                          alignment: AlignmentDirectional(-0.89, 3.67),
                          child: InkWell(
                              ...
                              child: StreamBuilder<List<ClientesRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final textClientesRecord =
                                      textClientesRecordList.isNotEmpty
                                          ? textClientesRecordList.first
                                          : null;
                                  return Text(
                    ...
                    child: StreamBuilder<List<ClientesRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        return Text(
                          dateTimeFormat(
                            'relative',
                            textClientesRecord!.fechaDePago!,
                  ...
                  StreamBuilder<List<ClientesRecord>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      List<ClientesRecord> calendarClientesRecordList =
                          snapshot.data!;
                      // Return an empty Container when the item does not exist.
                      if (snapshot.data!.isEmpty) {
                        return Container();
                      }
                      final calendarClientesRecord =
                          calendarClientesRecordList.isNotEmpty
                              ? calendarClientesRecordList.first
                              : null;
                      return FlutterFlowCalendar(
                        ...
                        initialDate: calendarClientesRecord!.fechaDePago,
                        rowHeight: 64.0,
